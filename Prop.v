...
(* Template and Example of a proof *)
...
Proof.
  apply ev_ind.
  Case "ev_O". unfold even. unfold evenb. reflexivity.
...
(* Prove ev_MyProp again, using apply MyProp_ind instead of the induction
   tactic. *)
...
(* Prove MyProp_ev and ev_MyProp again by constructing explicit proof objects by
   hand (as you did above in ev_plus4, for example). *)
